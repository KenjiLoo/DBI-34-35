...
if ($action == "select"){
    ...
    $city =  ucwords($_POST['citysel']);
    $country_id =  $_POST['countryidsel'];
    
    $sql = "SELECT * FROM city WHERE city_id = '$city_id' || city = '$city' || country_id = '$country_id'";
...
if ($action == "insert"){
    ...
    $city =  ucwords($_POST['cityins']);
    $country_id =  $_POST['countryidins'];
     
    // Attempt insert query execution
    $sql = "INSERT INTO city (city_id, city, country_id, last_update) VALUES ('$city_id', '$city', '$country_id', CURRENT_TIMESTAMP())";
...
if ($action == "update"){
    ...
    $city =  ucwords($_POST['cityupt']);
    $country_id =  $_POST['countryidupt'];
     
    // Attempt update query execution
    $sql = "UPDATE city SET city_id = $city_id, city = '$city', country_id = $country_id, last_update=CURRENT_TIMESTAMP() WHERE city_id='$city_id'";
